...
function DesktopSidebar() {
	...
	return (
		<Sidebar
			...
			className={twMerge(
				'inset-y-0 left-0 z-20 flex h-full shrink-0 flex-col border-r border-gray-200 rounded-none duration-75 lg:flex dark:border-gray-700',
				isCollapsed && 'hidden w-16',
			)}
			id="sidebar"
		>
			<div className="flex h-full flex-col justify-between" id="sidebaritem">
				<div className="py-2">
					<Sidebar.Items>
